		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Activity Shipment Address Update",
									"targetURL": "#zactaddrupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zactaddrupdate-display": {
								"semanticObject": "zactaddrupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zactaddrupdate",
									"url": sap.ui.require.toUrl("zactaddrupdate")
								}
							}
						}
					}
